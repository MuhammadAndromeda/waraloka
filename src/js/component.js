...
header.innerHTML = `
            ...
            <aside id="sidebar" class="w-[90%] h-screen py-6 px-8 bg-zinc-300/50 backdrop-blur-xs fixed right-0 top-0 gap-12 flex flex-col justify-start items-start translate-x-full transition-all duration-300">
                ...
                <ul class="w-[full] gap-3 font-inter-medium flex flex-col justify-center items-start">
                    ...
                    <li><a href="index.html#testimonial" class="text-white/80 text-lg text-center font-semibold drop-shadow-md drop-shadow-black/60 capitalize">testimoni</a></li>
                    <li><a href="index.html#news" class="text-white/80 text-lg text-center font-semibold drop-shadow-md drop-shadow-black/60 capitalize">berita</a></li>
                    <li><a href="index.html#about-us" class="text-white/80 text-lg text-center font-semibold drop-shadow-md drop-shadow-black/60 capitalize">tentang kami</a></li>
                </ul>
            </aside>
`;
